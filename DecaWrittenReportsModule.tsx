...
export const DecaWrittenReportsModule: React.FC = () => {
  ...
  const questions = [
    'How did you calculate your unit break-even volume, and what happens to your operating profit if wholesale product costs rise by 15%?',
    'Which target demographics (e.g. high school students, booster club parents) are you focusing your promotional campaigns on, and what is your projected Return on Marketing Investment (ROMI)?',
    'How will your store manage seasonal cash flow shortages during summer break to ensure vendor invoices are paid on time?',
    'What internal financial controls and cash-handling procedures will your team implement to prevent cash register discrepancies and inventory shrinkage?',
  ];
        ...
        <div className="bg-[#18181b] border border-[#27272a] p-5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="bg-[#09090b] border border-[#eab308] p-4 flex flex-col justify-between h-48">
              <span className="text-[10px] text-[#eab308] uppercase font-bold">SLIDE 01 · TITLE & VALUE PROP</span>
              <div className="text-sm font-bold text-white uppercase">Summit Spirit Store: Business Operations & Financial Plan</div>
              <span className="text-[10px] text-[#71717a]">Visual Props: Executive Summary & Logo Card</span>
            </div>

            <div className="bg-[#09090b] border border-[#27272a] p-4 flex flex-col justify-between h-48">
              <span className="text-[10px] text-[#71717a] uppercase font-bold">SLIDE 02 · BREAK-EVEN & PRICING</span>
              <div className="text-sm font-bold text-white uppercase">Unit Economics, Contribution Margin & Break-Even Chart</div>
              <span className="text-[10px] text-[#71717a]">Visual Props: Break-Even Volume Graph</span>
            </div>

            <div className="bg-[#09090b] border border-[#27272a] p-4 flex flex-col justify-between h-48">
              <span className="text-[10px] text-[#71717a] uppercase font-bold">SLIDE 03 · CASH FLOW & CONTROLS</span>
              <div className="text-sm font-bold text-white uppercase">12-Month Pro-Forma Cash Budget & POS Security</div>
              <span className="text-[10px] text-[#71717a]">Visual Props: Monthly Cash Inflow/Outflow Waterfall</span>
            </div>
          </div>
        </div>
      )}
